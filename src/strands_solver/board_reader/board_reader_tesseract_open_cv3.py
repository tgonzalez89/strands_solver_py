"""OpenCV + tesserocr board reader (v3) skeleton."""
...
class BoardReaderTesseractOpenCV3(BoardReaderBase):
    ...
    def _extract_cell_centers(self, image: object) -> list[list[PixelCoord]]:  # noqa: ARG002
            ...
            for row in range(self._rows):
                ...
                for col in range(self._cols):
                    ...
                    if len(cleaned_cell) == 1 and cleaned_cell in "ABCDEFGHIJKLMNOPQRSTUVWXYZ":
                        ...
                        if cleaned_cell == "D":
                            fallback_char = BoardReaderTesseractOpenCV3._ocr_d_cell_fallback(
                                tess_api,
                                cell_img,
                            )
    ...
    def _extract_cell_patch(image: cv2.typing.MatLike, center: PixelCoord) -> cv2.typing.MatLike:
        ...
        """
        img_cell_side = BoardReaderTesseractOpenCV3._patch_image_side()
        x, y = center
    ...
    def _classify_cell_state(cell_img: cv2.typing.MatLike) -> Highlight:
        ...
        """
        closest = BoardReaderTesseractOpenCV3._classify_cell_color(cell_img)
    ...
    def _patch_image_side(factor: float = 0.9) -> int:
        ...
        # Side is calculated as diamater * sqrt(2) / 2 (approximated as 0.7).
